...
@section('title', 'Admin Dashboard - TRIAS Group')
                    ...
                    <div class="row align-items-center">
                        <div class="col-xl-8 col-xxl-12">
                            <div class="text-center text-xl-start text-xxl-center mb-4 mb-xl-0 mb-xxl-4">
                                ...
                                <p class="text-gray-700 mb-0">Halaman ini memberikan gambaran umum tentang status pekerjaan dokumen yang sedang berjalan. Pantau progres, upload dokumen SN, dan kelola arsip dengan mudah.</p>
                            </div>
                        </div>
        ...
        <div class="col-xl-12 mb-4">
            <div class="card card-header-actions h-100">
                <div class="card-header">
                    Dokumen Terbaru
                     <a href="{{ route('admin.documents') }}" class="btn btn-sm btn-primary-soft text-primary">Lihat Semua</a>
                </div>
                <div class="card-body">
                         ...
                         <table class="table table-striped table-hover rounded">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td>{{ Str::limit($doc->judul_fpp, 50) }}</td>
...
@section('scripts')
{{-- Remove Litepicker if unused or keep if needed elsewhere, but user asked to remove calendar earlier --}}
<script>
